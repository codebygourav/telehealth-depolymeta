...
return [
    ...
    'app' => [
        ...
        'sections' => [
            ...
            'contact' => [
                ...
                'fields' => [
                    'email' => ['type' => 'email', 'label' => 'Contact Email', 'placeholder' => 'info@example.com', 'is_public' => true],
                    'phone' => ['type' => 'tel', 'label' => 'Contact Phone', 'placeholder' => '+91 1234567890', 'is_public' => true],
                    'support_email' => ['type' => 'email', 'label' => 'Support Email', 'is_public' => true],
            ...
            'whereby' => [
                ...
                'fields' => [
                    'whereby_api_key' => [
                        ...
                        'placeholder' => 'Enter your Whereby API Key (JWT token)',
                        'rows' => 3,
                        'env_key' => 'WHEREBY_API_KEY',
                        'helper' => 'Get your API key from https://whereby.com/information/embedded/. This is a JWT token and can be very long.',
                    ],
                    'whereby_base_url' => [
                        'type' => 'text',
                        'label' => 'Whereby Base URL',
                        'placeholder' => 'https://api.whereby.dev/v1',
                        'default' => 'https://api.whereby.dev/v1',
                        'env_key' => 'WHEREBY_BASE_URL',
                        'helper' => 'Default: https://api.whereby.dev/v1',
                    ],
                ],
            ],
            'razorpay' => [
                ...
                'fields' => [
                    'razorpay_key_id' => [
                        ...
                        'env_key' => 'RAZORPAY_KEY_ID',
                    ],
                    'razorpay_key_secret' => [
                        'type' => 'password',
                        'label' => 'Razorpay Key Secret',
                        'env_key' => 'RAZORPAY_KEY_SECRET',
                    ],
                    'razorpay_enabled' => [
                        'type' => 'toggle',
                    ...
                    'mock_booking_enabled' => [
                        'type' => 'toggle',
                        'label' => 'Enable Mock Booking Payment',
                        'default' => false,
                        'color' => 'success', // Add color. Use 'success', 'danger', etc. based on design system.
                        'helper' => 'Allows /book-appointment to confirm appointments with mock_payment=true without calling Razorpay.',
                    ],
    ...
    */
    ...
    | App Information
    |--------------------------------------------------------------------------
    | Consolidated tab for FAQ, About Us, Terms & Conditions, and Privacy Policy
    | Each section uses db_group to map to the correct database group
    */
    'app_information' => [
        'label' => 'App Content',
        ...
        'sections' => [
            'faq' => [
                ...
                'db_group' => 'faq', // Maps to database group 'faq'
                'fields' => [
                    'faq_items' => [
                        'type' => 'repeater',
                        'label' => 'FAQs',
            ...
            'about_us' => [
                ...
                'db_group' => 'about_us', // Maps to database group 'about_us'
                'fields' => [
                    'about_us_field' => ['type' => 'richtext', 'label' => 'About Us Content', 'placeholder' => '', 'required' => true, 'is_public' => true],
                ],
            ],
            'term_and_conditions' => [
                'label' => 'Term & Conditions',
                'description' => 'Terms and Conditions content',
                'db_group' => 'term_and_conditions', // Maps to database group 'term_and_conditions'
                'fields' => [
                    'term_and_condition_field' => ['type' => 'richtext', 'label' => 'Terms & Conditions Content', 'placeholder' => '', 'required' => true, 'is_public' => true],
                ],
            ],
            'privacy_policy' => [
                'label' => 'Privacy & Policy',
                'description' => 'Privacy and Policy content',
