    ...
    */
    ...
    'connections' => [
        ...
        'paid_appointments' => [
            ...
            'charset' => env('PAID_APPOINTMENT_DB_CHARSET', env('DB_CHARSET', 'utf8mb4')),
            'collation' => env('PAID_APPOINTMENT_DB_COLLATION', env('DB_COLLATION', 'utf8mb4_unicode_ci')),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('PAID_APPOINTMENT_MYSQL_ATTR_SSL_CA', env('MYSQL_ATTR_SSL_CA')),
            ]) : [],
        ],
