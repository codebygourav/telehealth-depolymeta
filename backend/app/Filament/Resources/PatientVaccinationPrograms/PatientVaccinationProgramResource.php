...
use App\Filament\Resources\PatientVaccinationPrograms\Pages\ListPatientVaccinationPrograms;
...
class PatientVaccinationProgramResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components(static::wrapSlideOverForm([
            static::slideOverSection('Assign Schedule To Patient Profile', [
                ...
                Select::make('status')
                    ...
                    ->required(),
            ], 'Choose the profile and schedule template. Saving creates all patient vaccine doses.', icon: 'heroicon-o-calendar-days'),
        ]));
    }
    ...
    {
        return [
            'index' => ListPatientVaccinationPrograms::route('/'),
        ];
    }
