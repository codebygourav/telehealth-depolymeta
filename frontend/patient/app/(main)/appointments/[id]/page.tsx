                        ...
                        },
                        {
                            onSuccess: (res) => {
                                ...
                                setDialogState({
                                    ...
                                    description: "Your appointment is confirmed. You will receive a confirmation email shortly.",
                                });
                            },
                            onError: () => {
                                setDialogState({
                ...
                <div className="container-max-width w-full mx-auto grid items-start grid-cols-1 gap-5 lg:grid-cols-12">
                    <div className="space-y-8 lg:col-span-7">
                        ...
                        <div className="grid items-start grid-cols-1 gap-5 lg:grid-cols-12">
                            ...
                            <div className="space-y-8 lg:col-span-6">
                                <ScheduleDetails
                                    schedule={schedule as AppointmentSchedule}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8 lg:col-span-5">
                        <PaymentSummary
                            payment={doctor.payment as AppointmentPayment}
                        />
                        ...
                        {doctor.payment.status === "paid" && (
                            <Button
                                onClick={() => {
                                    router.push(`/appointments/manage-appointment/${AppointmentId}`);
                                }}
