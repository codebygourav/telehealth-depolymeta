        ...
        {guidedVoiceSteps.map((step) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-[10px] font-semibold truncate leading-tight w-full">
                {step.title}
              </p>
              <p
                className={`text-[8px] leading-none ${isComplete ? "text-green-600 font-medium" : "text-muted-foreground"}`}
              >
      ...
      <div className="rounded-xl border bg-background p-3.5 space-y-3 shadow-inner relative">
        ...
        <div className="space-y-1">
          ...
          <Textarea
            ...
            onChange={(event) =>
              onGuidedTranscriptChange(guidedStep, event.target.value)
            }
            rows={3}
